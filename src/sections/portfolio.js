  ...
  return (
    ...
    >
      <div className="pb-32  text-center bg-white pt-8">
        ...
        <p className="text-lg opacity-70 leading-relaxed md:w-9/12 w-full md:mx-auto px-5 text-gray-800">
          Notus NextJS is a completly new product built using our past
          experience in web templates. Take the examples we made for you and
          start playing with them. Take the examples we made.
        </p>
      </div>
      <div className=" grid w-full md:grid-cols-3 grid-cols-1 md:gap-8 gap-32 text-gray-800  md:px-20 px-5 md:pb-26 pb-8 ">
        {[0, 1, 2].map((e, index) => (
          <div key={e} className=" -mt-24 mx-auto ">
            <h2
